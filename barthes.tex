...
\begin{document}
	...
	\begin{tikzpicture}
	\draw[step=0.75, line width=0.7pt] (0,0) grid (9.75,5.25);
		\draw[line width=0.7pt] (0,4.50)--(-2.57,4.50);
		\draw[line width=0.7pt] (0,5.25)--(-2.57,5.25);
	...
	%for-loop for numbers 1-13
	\foreach \x in {0,...,12} 
	{\pgfmathtruncatemacro{\label}{\x+1}
	\node at (0.375+0.75*\x,4.875) {\label};}
	...
	%vertical lines
	\draw[line width=1.1pt] (0,1.57)--(0,1.27);
	\draw[line width=1.1pt] (0,0.95)--(0,0.55);
	\draw[line width=1.1pt] (0,0.25)--(0,-0.25);
	\draw[line width=1.1pt] (0,-0.97)--(0,-0.55);
	\draw[line width=1.1pt] (0,-1.63)--(0,-1.33);
	\end{tikzpicture}
	...
	%bottom lines
	\draw[very thick] (-1.05,0.15) to[bend right] (-1.55,0.5)--(-4.5,0.5) to[bend left] (-5,1.1);	%Will--1
	\draw[very thick] (-0.75,0.35) to[bend right] (-1.75,1) to[bend left] (-2.5,1.55);				%Will--2
	\draw[very thick] (-0.15,0.37) to[bend right] (-0.35,0.8) to[bend left] (-0.55,1.2);			%Will--3
	\draw[very thick] (0.25,0.38) to[bend left] (1.25,1.1) to[bend right] (2,1.55);					%Will--4
	\draw[very thick] (1,0.15) to[bend left] (1.5,0.5)--(4.5,0.5) to[bend right] (5,1.1);			%Will--5
	
	%middle lines
	\draw[very thick] (-2.75,2.5) to[bend right] (-3.25,3)--(-5.1,3) to[bend left] (-5.5,3.5);	%2--academic
	\draw[very thick] (-2.5,2.5) to[bend right] (-3.25,3.5) to[bend left] (-4,4.75);	%2--romantic
	\draw[very thick] (-2.25,2.5) to[bend left] (-2,3) to[bend right] (-1.5,3.5);		%2--hallucinatory
	\draw[very thick] (2,2.45)--(1.6,3.4);  											%4--6
	
	%upper lines	
	\draw[very thick] (1.5,4.65) to[bend right] (1,5.5) to[bend left] (0.35,6.55);		%6--7
	\draw[very thick] (1.7,4.65) to[bend left] (2.1,5.5) to[bend right] (2.55,6.55);	%6--8
